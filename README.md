...
- Not implemented: Random Forest production integration (offline research only), Geofencing, and Maps SDK live integration (mobile uses UI placeholder). Geographic resolution is at State/UT granularity only; city, district, and sub-district resolution are not implemented.
